...
class MOT17_Wrapper(Dataset):
	...
	def __init__(self, split, dets, dataloader):
		...
		"""
		train_sequences = ['MOT17-11', 'MOT17-02', 'MOT17-04', 'MOT17-09', 'MOT17-10', 'MOT17-13', 'MOT17-05']
		...
		self._data = []
		det_list = ["SDP"]
		np.random.shuffle(det_list)
		for s in sequences:
			if dets == '17':
				for d_name in det_list:
					self._data.append(MOT17_Sequence(seq_name=s, dets=d_name+'17', **dataloader))
			else:
