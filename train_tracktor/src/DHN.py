...
class Munkrs(nn.Module):
    def __init__(self, element_dim, hidden_dim, target_size, bidirectional, minibatch, is_cuda, is_train=True,
        ...
        self.lstm_row = nn.GRU(element_dim, hidden_dim, bidirectional=self.bidirect, num_layers=2, dropout=0.0)
        self.lstm_col = nn.GRU(hidden_dim*2, hidden_dim, bidirectional=self.bidirect, num_layers=2, dropout=0.0)
